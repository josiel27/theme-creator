...
export class DecimalSortComponent implements OnInit {
  numberAtual: any = 0;
  maxNumber = 10000000000000000000000000010000000000000000000000000010000000000000000000000100000000000000000000000000100000000000000000000;
  minNumber = 0;
  numberHex = '';
  increment = 10000000000000000000000000010000000000000000000000000010000000000000000000000;
  constructor() { }
